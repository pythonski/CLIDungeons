class Item:
    ...
    def __init__(self, name, category=None, is_equipable=False, quantity=1, encumbrance_modifier=0,encumbrance_ranged_modifier=0, attack_modifier=0, armor_modifier=0, health_modifier=0, health_max_modifier=0, magic_modifier=0, agility_modifier=0, abilities_modifier=0, enemy_armor_modifier=0):
        ...
        if name in (melee_weapons + ranged_weapons + armors):
            self.name = name
            ...
            if name in melee_weapons:
                ...
                elif name in twohanded_weapons:
                    self.encumbrance_modifier = 2

                if name in light_weapons:
                    self.agility_modifier = 1
                    self.enemy_armor_modifier = 1

                if name in twohanded_weapons:
                    self.agility_modifier = -1
                    self.enemy_armor_modifier = -1
            ...
            self.enemy_armor_modifier = enemy_armor_modifier
